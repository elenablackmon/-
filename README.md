...
Также установите библитеки из файла requirements.txt.
...
Для работы через телеграм-бот получите от BotFather токен (API ключ) и запустите скрипт: python telebot_nutritionist.py.
